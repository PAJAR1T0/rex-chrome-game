...
export const checkColition = ({obstacleActualX, drawY, obstacleHeight, obstacleWidth, type}: {obstacleActualX: number, drawY: number, obstacleHeight: number, obstacleWidth: number, type: string}) => {
